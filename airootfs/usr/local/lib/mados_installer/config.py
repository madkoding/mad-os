...
PACKAGES_PHASE2 = [
    ...
    'xf86-video-nouveau',
    # GPU Compute drivers (CUDA / ROCm) are NOT listed here — they are
    # conditionally installed on first boot only when matching hardware is
    # detected.  See GPU_COMPUTE_PACKAGES below.
    'ocl-icd',
