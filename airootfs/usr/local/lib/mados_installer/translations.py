...
TRANSLATIONS = {
    "English": {
        ...
        "features": [
            (FEATURE_OPENCODE_AI, "• Optimized 1.9GB RAM"),
            ("• Sway compositor", "• Developer-ready"),
            (FEATURE_ZRAM_EARLYOOM, "• Kernel tuning"),
        ],
        "language": "Language:",
    ...
    "Español": {
        ...
        "features": [
            ("• OpenCode IA", "• Optimizado 1.9GB RAM"),
            ("• Compositor Sway", "• Entorno desarrollo"),
            (FEATURE_ZRAM_EARLYOOM, "• Ajuste kernel"),
        ],
        "language": "Idioma:",
    ...
    "Français": {
        ...
        "features": [
            ("• OpenCode IA", "• Optimisé 1.9GB RAM"),
            ("• Compositeur Sway", "• Prêt développement"),
            (FEATURE_ZRAM_EARLYOOM, "• Tuning kernel"),
        ],
        "language": "Langue:",
    ...
    "Deutsch": {
        ...
        "features": [
            ("• OpenCode KI", "• Optimiert 1.9GB RAM"),
    ...
    "中文": {
        ...
        "features": [
            (FEATURE_OPENCODE_AI, "• 优化1.9GB内存"),
            ("• Sway合成器", "• 开发就绪"),
            (FEATURE_ZRAM_EARLYOOM, "• 内核调优"),
        ],
        "language": "语言:",
        "start_install": "开始安装",
        "exit": "退出",
    ...
    "日本語": {
        ...
        "features": [
            (FEATURE_OPENCODE_AI, "• 1.9GB RAM最適化"),
            ("• Swayコンポジター", "• 開発準備完了"),
            (FEATURE_ZRAM_EARLYOOM, "• カーネル調整"),
        ],
        "language": "言語:",
