...
const translations = {
    es: {
        ...
        'feature.installer.desc': 'Tres opciones de instalación: GTK gráfico, TUI en terminal o CLI para expertos.',
        
        // Installers
        'installers.title': 'Tres Formas de Instalar',
        'installers.subtitle': 'Elige el instalador que mejor se adapte a tu estilo',
        'installer.recommended': 'Recomendado',
        ...
        'installer.gtk.feat2': '✓ Logo y diseño visual madOS',
        'installer.gtk.feat3': '✓ Navegación con mouse',
        'installer.gtk.feat4': '✓ Progreso visual en tiempo real',
        'installer.gtk.size': '~15MB de dependencias extras',
        'installer.tui.title': 'TUI Installer',
        'installer.tui.subtitle': 'Terminal con colores',
        'installer.tui.feat1': '✓ Interfaz de texto con colores',
        'installer.tui.feat2': '✓ Navegación solo con teclado',
        'installer.tui.feat3': '✓ Arte ASCII de marca',
        'installer.tui.feat4': '✓ Sin entorno gráfico requerido',
        'installer.tui.size': '~200KB (dialog)',
        'installer.cli.title': 'CLI Installer',
        'installer.cli.subtitle': 'Línea de comandos pura',
        'installer.cli.feat1': '✓ Instalador original',
        'installer.cli.feat2': '✓ Mínimo, rápido, sin adornos',
        'installer.cli.feat3': '✓ Para usuarios avanzados',
        'installer.cli.feat4': '✓ Ideal para automatización',
        'installer.cli.size': 'Sin dependencias extras',
        
        // Hardware
        'hardware.title': 'Hardware Objetivo',
        'hardware.subtitle': 'madOS está optimizado para dar nueva vida a hardware modesto',
        'hardware.cpu': 'CPU',
        'hardware.cpu.desc': 'Intel Atom o equivalente',
        'hardware.ram': 'RAM',
        ...
        'download.iso.desc': 'Obtén la última versión desde GitHub Actions',
        'download.iso.button': 'Ver Artifacts en GitHub Actions',
    ...
    en: {
        ...
        'feature.installer.desc': 'Three installation options: graphical GTK, terminal TUI, or CLI for experts.',
        
        // Installers
        'installers.title': 'Three Ways to Install',
        'installers.subtitle': 'Choose the installer that best fits your style',
        'installer.recommended': 'Recommended',
        'installer.gtk.title': 'GTK Installer',
        'installer.gtk.subtitle': 'Beautiful graphical interface',
        'installer.gtk.feat1': '✓ Graphical interface with Nord theme',
        'installer.gtk.feat2': '✓ madOS logo and visual design',
        'installer.gtk.feat3': '✓ Mouse navigation',
        'installer.gtk.feat4': '✓ Real-time visual progress',
        'installer.gtk.size': '~15MB extra dependencies',
        'installer.tui.title': 'TUI Installer',
        'installer.tui.subtitle': 'Colorful terminal',
        'installer.tui.feat1': '✓ Colored text interface',
        'installer.tui.feat2': '✓ Keyboard-only navigation',
        'installer.tui.feat3': '✓ ASCII brand art',
        'installer.tui.feat4': '✓ No graphical environment required',
        'installer.tui.size': '~200KB (dialog)',
        'installer.cli.title': 'CLI Installer',
        'installer.cli.subtitle': 'Pure command line',
        'installer.cli.feat1': '✓ Original installer',
        'installer.cli.feat2': '✓ Minimal, fast, no frills',
        'installer.cli.feat3': '✓ For advanced users',
        'installer.cli.feat4': '✓ Ideal for automation',
        'installer.cli.size': 'No extra dependencies',
        
        // Hardware
        'hardware.title': 'Target Hardware',
        'hardware.subtitle': 'madOS is optimized to breathe new life into modest hardware',
        'hardware.cpu': 'CPU',
        'hardware.cpu.desc': 'Intel Atom or equivalent',
        'hardware.ram': 'RAM',
        ...
        'download.iso.desc': 'Get the latest version from GitHub Actions',
        'download.iso.button': 'View Artifacts on GitHub Actions',
